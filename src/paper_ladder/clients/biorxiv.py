"""bioRxiv client for Paper-Ladder.

API Documentation: https://api.biorxiv.org/
- Content API: https://api.biorxiv.org/details/[server]/[interval]/[cursor]/[format]
- Publisher API: https://api.biorxiv.org/publisher/[prefix]/[interval]/[cursor]/[format]
"""
...
class BiorxivClient(BaseClient):
    ...
    bioRxiv is a preprint repository for biology research.
    The API provides access to preprints with DOIs and metadata.

    API docs: https://api.biorxiv.org/

    Note: bioRxiv API returns batches of 100 results.
    Rate limit is not strictly documented but be respectful.
    """
    ...
    async def search(
        ...
        **kwargs: object,
        ...
        For better results, use search_by_date() or search_by_doi().
    ...
    async def get_paper(self, identifier: str) -> Paper | None:
        ...
        Args:
            identifier: bioRxiv DOI (e.g., "10.1101/2024.01.01.123456").
        ...
        try:
            response = await self._get(f"/details/biorxiv/{doi}")
            data = response.json()
    ...
    async def search_by_category(
        ...
        **kwargs: object,
        ...
        """Search for papers by bioRxiv category.

        Args:
            category: bioRxiv category (e.g., "neuroscience", "genomics").
    ...
    async def search_with_cursor(
        ...
        **kwargs: object,
        ...
        while True:
            # bioRxiv returns 100 results per page
            url = f"/details/biorxiv/{from_date}/{to_date}/{cursor}"
            try:
    ...
    def _parse_entry(self, entry: dict[str, Any]) -> Paper | None:
        """Parse a bioRxiv API entry into a Paper.
